 ...
 *)
 ...
 -- list your pogo addresses here
 property pogo_1 : "00-04-48-17-c7-06"
 property pogo_2 : "00-04-48-13-eb-fb"
 
 
 
 -- the address of your pogo device
 property pogo_address : ""
 
 property done_foldername : "Printed Images"
 ...
 property aCounter : 1 -- this is the absolute inital value of the counter
 
 
if aCounter = 1 then
	set aCounter to aCounter + 1
	set pogo_address to pogo_1
    else if aCounter = 2 then
	set aCounter to 1
	set pogo_address to pogo_2
end if
...
on process_item(this_item)
	...
	try
        ...
        tell application "Bluetooth File Exchange"
            -- change the address of your Pogo printer to match below
            send file POSIX path of this_item to device pogo_address
